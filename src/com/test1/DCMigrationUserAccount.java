...
public class DCMigrationUserAccount {
	private Integer dataMigrationOwner;
	...
	public DCMigrationUserAccount() {

	}

	public DCMigrationUserAccount(Integer dataMigrationOwner, String dataMigrationName, String firstName,
	...
	public Integer getDataMigrationOwner() {
		return dataMigrationOwner;
	}

	public void setDataMigrationOwner(Integer dataMigrationOwner) {
		this.dataMigrationOwner = dataMigrationOwner;
	}

	public String getDataMigrationName() {
		return dataMigrationName;
	}

	public void setDataMigrationName(String dataMigrationName) {
		this.dataMigrationName = dataMigrationName;
	}
